...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void initializableNodes() { // metodo responsavel de vincular a propriedade da classe com o tableview
		...
		Stage stage = (Stage) Main.getMainScene().getWindow(); // pega tamnho da tela pricipal fazendo um downcasting
																// para stage
		tableViewDepartment.prefHeightProperty().bind(stage.heightProperty()); // atribui o tamnho anterior para o
																				// tableview
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.subscribeDataChangeListener(this); // adiciona objeto para receber a notificação do observer
